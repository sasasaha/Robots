...
void main (void)
{
  ...
  if (FldOneH >= FldTwoH && FldOneW >= FldTwoW)
	S = FldOneH * FldOneW;
  else if (FldOneH < FldTwoH && FldOneW < FldTwoW)
    S = FldTwoH * FldTwoW;
  else if (FldOneH > FldTwoH)
	S = FldTwoH * FldTwoW + (FldOneH * FldOneW - FldTwoH * FldOneW);
  else if (FldOneH < FldTwoH)
	S = FldOneH * FldOneW + (FldTwoH * FldTwoW - FldOneH * FldTwoW);
  /*else if (FldOneW > FldTwoW)
	S = FldTwoH * FldTwoW + (FldOneH * FldTwoW - FldTwoH * FldOneW);
  else if (FldOneW < FldTwo)
	S = FldTwoH * FldTwoW + (FldOneH * FldTwoW - FldTwoH * FldOneW);*/
